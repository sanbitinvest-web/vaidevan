...
router.post("/partners", async (req, res) => {
    const { type, name, email, phone, cpf, cnpj, companyName, city, state, message, howFound, cnhUrl, addressProofUrl, selfieUrl, crlvUrls, contratoSocialUrl, commercialRefs, registrationGeoLat, registrationGeoLng, registrationGeoAccuracy, 
    // Novos campos KYC
    occupation, patrimony, sourceOfFunds, investmentIntent, competitorDeclaration, } = req.body;
    ...
    try {
        ...
        res.status(201).json({
            ...
            investorCreated,
            message: (type || "investidor") === "investidor"
